...
function initAdmin(socket) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get("/admin/orders", {
    ...
    // orders array will be stored with res.data
    orders = res.data;
  ...
  socket.on("orderPlaced", function (order) {
    new (noty__WEBPACK_IMPORTED_MODULE_2___default())({
      ...
      progressBar: false
    }).show(); // Add the order at the start
...
socket.on("orderUpdated", function (data) {
  ...
  var updatedOrder = _objectSpread({}, order); // Update the order
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtime_showroom"] = self["webpackChunkrealtime_showroom"] || [];
